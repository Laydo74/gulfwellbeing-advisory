...
const articles: Record<string, ArticleProps> = {
  ...
  "bien-etre-prive-dubai": {
    ...
    sections: [
      ...
      ["Le déroulement d'un premier échange", "Un premier échange privé se fait sans précipitation. Il ne commence pas par un questionnaire standardisé, mais par une écoute attentive : ce qui motive la démarche aujourd'hui, le rythme habituel de la semaine, et les domaines de vie qui appellent le plus d'attention. Un protocole privé se dessine ensuite, à un rythme adapté à l'agenda du client plutôt qu'à un parcours identique pour tous."],
      ["Dubaï, une vie professionnelle et personnelle particulièrement dense", "Dubaï réunit souvent des agendas internationaux, une visibilité professionnelle importante et des responsabilités familiales qui laissent peu de répit. Une conseillère qui connaît ce rythme, ses exigences de discrétion et le calendrier des affaires dans le Golfe peut offrir une continuité qu'un programme de bien-être générique ne propose pas."],
      ["La confidentialité comme principe de travail", "Pour de nombreux clients, la confidentialité n'est pas une option mais une condition. Dirigeants exposés publiquement, conseillers de cours royales, responsables de family offices et entrepreneurs visibles ont besoin de la certitude qu'une conversation privée le restera. Cela implique des accords clairs de non-divulgation, une logistique de séance soignée, et une conseillère pour qui la discrétion est une discipline professionnelle, non un argument commercial."],
      ["Séances en présentiel ou en visioconférence chiffrée", "Le conseil privé en bien-être à Dubaï se décline généralement sous deux formes : des rencontres en personne dans un cadre discret, ou des séances virtuelles chiffrées pour les clients qui voyagent fréquemment entre les capitales du Golfe et les grandes places internationales. Beaucoup de clients de longue date alternent les deux formats selon les périodes de l'année."],
      ["Ce qui distingue une conseillère privée d'un coach de bien-être généraliste", "Un accompagnement de bien-être généraliste suit souvent un programme standard appliqué à tous les clients. Le conseil privé, à l'inverse, se construit entièrement autour du contexte d'une seule personne : ses responsabilités, sa structure familiale, son environnement culturel et ses ambitions à long terme. La relation s'inscrit dans la durée, sur plusieurs années plutôt que sur quelques semaines, ce qui permet au protocole d'évoluer avec la situation du client."],
      ["Les questions à se poser avant de commencer", "Avant d'entamer une démarche de bien-être privé, il peut être utile de se demander : la discrétion est-elle une priorité réelle, au-delà d'un simple accord de confidentialité standard ? Une conseillère trilingue, familière des dynamiques familiales et professionnelles du Golfe, faciliterait-elle l'échange ? Préfère-t-on des séances en présentiel, à distance, ou une combinaison des deux selon les saisons ?"],
      ["Une approche adaptée à chaque étape de vie", "Un dirigeant en pleine levée de fonds, une mère qui reprend une activité professionnelle après une naissance, ou un couple qui navigue un déménagement entre deux pays du Golfe n'ont pas les mêmes besoins. Le conseil privé s'ajuste à l'étape réellement traversée plutôt que d'imposer une trame identique pour toutes les situations, ce qui explique pourquoi la durée et la fréquence des séances varient beaucoup d'un client à l'autre."],
      ["Le rôle de la culture et de la famille dans l'accompagnement", "À Dubaï comme dans les autres capitales du Golfe, la vie personnelle s'inscrit souvent dans un tissu familial élargi, avec des attentes propres à chaque famille, chaque nationalité et chaque parcours. Une conseillère attentive à ce contexte ne cherche pas à imposer un modèle occidental de bien-être, mais à comprendre la réalité vécue par la personne, dans le respect de ses valeurs et de son histoire."],
      ["Bien-être privé et vie professionnelle à haute responsabilité", "Fondateurs, cadres dirigeants et professionnels très exposés partagent souvent un même constat : la réussite visible masque parfois une fatigue accumulée, des décisions permanentes et un manque de temps pour soi. Le conseil privé propose un espace où cette réalité peut être nommée sans jugement, avant d'envisager des ajustements concrets et réalistes dans l'organisation du quotidien."],
      ["Vie de famille et vie professionnelle : trouver un langage commun", "Beaucoup de clients à Dubaï jonglent entre plusieurs rôles dans la même journée : diriger une équipe, accompagner des enfants scolarisés dans un système international, entretenir des liens avec la famille restée dans le pays d'origine. Le conseil privé aide à clarifier les priorités entre ces rôles plutôt que de les traiter comme des obligations concurrentes et épuisantes."],
      ["Ce que l'on peut attendre après plusieurs mois d'accompagnement", "Les clients qui poursuivent un accompagnement privé sur la durée rapportent généralement une meilleure lecture de leurs propres limites, une capacité accrue à distinguer l'urgent de l'important, et un sentiment de contrôle renouvelé sur leur emploi du temps. Ces évolutions restent progressives et personnelles ; elles ne relèvent d'aucune promesse standardisée."],
      ["Prendre le premier rendez-vous", "La demande initiale se fait généralement de façon discrète, par un formulaire privé ou une prise de contact directe. Un court échange permet ensuite de clarifier les attentes, le format souhaité et la disponibilité, avant de fixer une première séance à Dubaï ou en visioconférence chiffrée pour les clients situés ailleurs dans le Golfe."],
      ["Bien-être privé et santé mentale : une distinction importante", "Le conseil privé en bien-être n'est pas un traitement médical ou psychologique et ne prétend pas s'y substituer. Il s'agit d'un espace de réflexion, de clarté et d'accompagnement personnel. Lorsqu'une situation nécessite un diagnostic, une thérapie ou un suivi clinique, la conseillère oriente systématiquement le client vers un professionnel de santé qualifié, en toute transparence sur les limites de son propre rôle."],
      ["La place du français dans un accompagnement à Dubaï", "Une part importante de la communauté francophone du Golfe — cadres expatriés, entrepreneurs, familles installées depuis plusieurs générations — recherche un accompagnement dans sa langue maternelle, sans passer par un intermédiaire ou une traduction approximative des nuances émotionnelles. Pouvoir exprimer une inquiétude, une hésitation ou une ambition directement en français change souvent la qualité de l'échange."],
      ["Un accompagnement qui s'inscrit dans la durée", "Contrairement à un programme de coaching de courte durée, le conseil privé se construit comme une relation de confiance qui peut s'étendre sur plusieurs années. Les priorités évoluent : une phase de forte croissance professionnelle succède parfois à une période de réorganisation familiale, puis à un projet de relocalisation. L'accompagnement suit ces évolutions plutôt que de s'arrêter à un objectif unique fixé au départ."],
      ["Discrétion, réseau et recommandations", "Beaucoup de clients découvrent ce type d'accompagnement par recommandation, au sein de cercles professionnels ou familiaux où la discrétion est elle-même une valeur partagée. Cette dynamique renforce l'exigence de confidentialité : chaque nouvelle relation de conseil doit mériter la même confiance que celle accordée par les clients qui l'ont précédée."],
      ["Concilier ambition professionnelle et vie privée", "À Dubaï, il n'est pas rare qu'une même personne pilote une expansion d'entreprise, gère une équipe multiculturelle et prenne des décisions familiales majeures dans la même période. Le conseil privé ne cherche pas à réduire l'ambition professionnelle, mais à s'assurer qu'elle ne se construit pas au prix d'un épuisement silencieux ou d'une vie personnelle mise en pause indéfiniment."],
      ["Le rythme des saisons dans le Golfe", "Le calendrier social et professionnel du Golfe connaît ses propres cycles : la période estivale de voyages, les mois plus denses en événements d'affaires, le Ramadan et les fêtes qui recomposent les priorités familiales. Un accompagnement privé attentif à ces rythmes propose un calendrier de séances qui s'ajuste naturellement plutôt qu'un format rigide toute l'année."],
      ["Un espace pour les couples et les familles expatriées", "L'installation dans le Golfe s'accompagne souvent d'un déracinement partiel : éloignement de la famille élargie, nouveau cercle social à construire, système scolaire différent pour les enfants. Ces ajustements, même vécus positivement, demandent une énergie invisible. Un espace privé permet au couple ou à chaque parent de nommer ces tensions avant qu'elles ne s'installent durablement dans le quotidien familial."],
      ["Pourquoi la première impression compte", "Le choix d'une conseillère privée repose largement sur la confiance ressentie dès le premier échange. Le ton, l'écoute, la capacité à comprendre le contexte du Golfe sans le réduire à des clichés, et la clarté sur le déroulement des séances sont autant d'éléments qui permettent au client de savoir, dès le départ, si cette relation de conseil lui correspond."],
      ["Ce que le bien-être privé n'est pas", "Il est utile de préciser ce que cet accompagnement ne prétend pas être : il ne remplace pas une thérapie de couple, un suivi psychiatrique ou un programme médical de perte de poids. Il ne promet pas non plus une transformation immédiate. Il s'agit d'un espace de réflexion structuré, mené par une professionnelle qui sait reconnaître les limites de son propre rôle et orienter vers un confrère qualifié lorsque la situation l'exige."],
    ],
    faqs: [
