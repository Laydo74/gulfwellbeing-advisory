    ...
    <section className="page-hero">
      <div className="mx-auto grid min-h-[68vh] max-w-[1440px] items-center gap-12 px-6 py-20 lg:grid-cols-2 lg:px-12">
        <div>
          ...
          <p className="mt-7 max-w-xl text-lg leading-9 text-muted-foreground">مقالات أصلية باللغة العربية حول الرفاه، الضغط، العلاقات، الأسرة، القيادة والتحولات الشخصية في حياة مليئة بالمسؤوليات.</p>
        </div>
