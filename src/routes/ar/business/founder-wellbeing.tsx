...
export const Route = createFileRoute("/ar/business/founder-wellbeing")({
  head: () => pageHead("رفاه المؤسسين | GULFWELLBEING","استشارات خاصة في رفاه المؤسسين حول ضغط المسؤولية، القرارات، الحدود والجانب الشخصي من ريادة الأعمال."),
  component: Page,
});
...
function Page(){return <SiteShell><article dir="rtl" className="mx-auto max-w-4xl px-6 py-24 lg:px-12">
  ...
  <p className="mt-7 text-xl leading-9 text-muted-foreground">مساحة خاصة للشخص الذي يحمل الشركة وقراراتها وعدم اليقين المرتبط بها.</p>
