...
function Page() {
  return <SiteShell>
    <article className="mx-auto max-w-4xl px-6 py-24 lg:px-12">
      ...
      <p className="mt-7 text-xl leading-9 text-muted-foreground">A private space for the person carrying the company, the decisions and the uncertainty behind the business.</p>
