...
function Page() {
  return <SiteShell>
    <article className="mx-auto max-w-4xl px-6 py-24 lg:px-12">
      ...
      <p className="mt-7 text-xl leading-9 text-muted-foreground">A discreet external perspective on the human side of leadership, pressure and organisational change.</p>
